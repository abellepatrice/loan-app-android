                    ...
                    override fun onResponse(call: Call<LoginResponse>, response: Response<LoginResponse>) {
                        if (response.isSuccessful && response.body() != null) {
                            ...
                            with(sharedPref.edit()) {
                                ...
                                putString("userUsername", loginResponse.user.username)
                                putString("userId", loginResponse.user.id)
                                putString("profileImage", loginResponse.user.profileImage)
                                putString("userRole", loginResponse.user.role ?: "user")
                                apply()
                            }
...
//import com.patrice.abellegroup.models.LoginRequest
//import com.patrice.abellegroup.models.LoginResponse
//import com.patrice.abellegroup.models.User
//import retrofit2.Call
//import retrofit2.Callback
//import retrofit2.Response
//
